//*********************************************************************************
/* FILE NAME: project5_Kim_jjk0027
 * USER ID: jjk0027
 * AUTHOR: Joshua Kim
 * Compile command: g++ project5_Kim_jjk0027.cpp -o project5.out
 * Run Command: ./project5.out
 */
//*********************************************************************************
...
{    
    ...
    {        
        ...
        // been locked, that means someone is using the "dressing room", the threadwill        
...
{    
    ...
    int banner_id = 904128615;    
    // #8#END# DO NOT MODIFY THIS COMMENT LINE!    
    cout << "Banner id: " << banner_id << endl;    
    pthread_t pro, con;     
    pthread_mutex_init(&the_mutex, 0);      
    // create the mutex used by thread    
    pthread_cond_init(&condc,0);            
    // intialize the condition varible for consumer    
    pthread_cond_init(&condp,0);            
    // initalize the condition varible for producer    
    pthread_create(&con, 0, consumer, 0);   
    // create thread map to function consumer    
    pthread_create(&pro, 0, producer, 0);   
    // create thread map to function producer    
    pthread_join(pro,0);                    
    // put the producer thread into the system    
    pthread_join(con,0);                    
    // put the consummer thread into the system    
